...
addpath( sDirScript );
sDirInput = './AllTestRetestRegress/Test';
cd( sDirInput );
...
cfg.files.mask = '/home/Xiaoxiao/Disks/Fast/TMP/AllTestRetestRegress/Utilities/brainmask.2mm+tlrc.HEAD';
